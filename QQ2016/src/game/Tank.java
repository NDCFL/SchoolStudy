...
public class Tank {
	public static  int speedX = 6, speedY =6; // ��̬ȫ�ֱ��ٶ�---------������Ϊ)��4���ü����ٶȿ�Ļ��Ƚ���
	...
	public Bullets fire() {  //���𷽷�
		...
		Bullets m = new Bullets(x, y + 2, good, Kdirection, this.tc);  //û�и���ʱ����ԭ4�ķ��򷢻�
		tc.bullets.add(m);                                                
		return m;
	}
