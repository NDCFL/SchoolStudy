...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>学生管理 <span class="c-gray en">&gt;</span> 资讯列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" onclick="refush();" id="userlist"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
        <a href="javascript:;" onclick="del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
        <a class="btn btn-primary radius" data-title="添加用户"  onclick="users_add('添加用户','<%=path%>/users/inituserAdd','','310')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加学生</a></span>
            ...
            <c:forEach items="${usersList}" var="s">
                <tr class="text-c">
                    ...
                    <td class="f-14 td-manage">
                        <a style="text-decoration:none" class="ml-5" onClick="users_edit('用户编辑','<%=path%>/users/findUsers/${s.id}','','310')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                        <a style="text-decoration:none" class="ml-5" onClick="users_del(this,'${s.id}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
                        <a style="text-decoration:none" class="ml-5" href="<%=path%>/orders/orderList/${s.id}" title="我的账单">我的账单</a>
                        <a style="text-decoration:none" class="ml-5" href="<%=path%>/ordersItems/pagelistbyuserid/${s.id}" title="我的账单">我的账单</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<script>
    ...
    function list(){
        window.location.href="<%=path%>/users/usersList";
    }
</script>
<script type="text/javascript">
    ...
    function users_edit(title,url,w,h){
    ...
    function orders_list(obj,id){
        window.location.href="<%=path%>/orders/ordersList/id";
    }
    /*用户-删除*/
    ...
    /*用户-添加*/
    function users_add(title,url,w,h){
        layer_show(title,url,w,h);
    }
</script>
</body>
