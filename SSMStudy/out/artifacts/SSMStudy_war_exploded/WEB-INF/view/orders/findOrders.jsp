    ...
    <form class="form form-horizontal"  id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${orders.name}" placeholder="" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>下单时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text easyui-datetimebox" style="width:566px" value="" placeholder="" id="createTime" name="createTime">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>订单价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" min="0" value="${orders.price}"  style="width:566px" placeholder="" id="price" name="price">
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        $("#createTime").datetimebox("setValue","${orders.createTime}");
    });
    ...
    $(function(){
        ...
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                //$(form).ajaxSubmit();
                $.post(
                    "<%=path%>/orders/updateOrders",$("#form-member-add").serialize(),
                    function(data){
                    },
                    "json"
                );
