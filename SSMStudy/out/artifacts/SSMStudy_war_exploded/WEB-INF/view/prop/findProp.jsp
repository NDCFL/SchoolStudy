    ...
    <form class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prop.propName}" placeholder="" id="propName" name="propName">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>道具价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${prop.propPrice}" placeholder="" id="propPrice" name="propPrice">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					<select name="propGenre" class="select">
						<option value="-1">请选择道具类型</option>
                            <option id="kill1" value="0">英雄</option>
                            <option id="kill2"  value="1">武器</option>
                            <option id="kill3"  value="2">装备</option>
					</select>
				</span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="propSkill" cols="" id="propSkill" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="checkpropSkill(this.value);">${prop.propSkill}</textarea>
...
<script type="text/javascript">
    $(function(){
        $("#kill${prop.propGenre}").attr("selected","selected");
    });
    $(function(){
        var str ="${prop.propSkill}" ;
        $("#num").text(str.length);
    });
</script>
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                //$(form).ajaxSubmit();
                $.post("<%=path%>/prop/updateProp",$("#form-member-add").serialize(),
                    function(data){
                    },
                    "json"
                );
