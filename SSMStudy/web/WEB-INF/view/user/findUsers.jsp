	...
	<form class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${users.name}" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>年龄：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${users.age}" placeholder="" id="age" name="age">
			</div>
		</div>
		<div class="row cl">
    ...
    $(function(){
        ...
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                //$(form).ajaxSubmit();
				$.post("<%=path%>/users/usersUpdateSave",$("#form-member-add").serialize(),
					function(data){
					},
					"json"
				);
