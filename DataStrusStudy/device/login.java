	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==login){
			...
			if(user.getText().equals("")){
				JOptionPane.showMessageDialog(null, "管理员不能为空","注册信息",JOptionPane.ERROR_MESSAGE);
				return;
			...
			dispose();
			JOptionPane.showMessageDialog(null, "恭喜你注册成功！开始使用吧","设备管理注册",JOptionPane.INFORMATION_MESSAGE);
			new devicemanager();
		}
