...
public class shoppingadd extends JFrame implements ActionListener{
	...
	public shoppingadd(int n) {
		...
		p1 = new JPanel(null);
		p1.setBackground(new Color(200,25,25,26));
		readfile();
		//判断是新增还是修改
		if(n==-2){
			title = new JLabel("加入货物", JLabel.CENTER);
			title.setBounds(70, 15, 100, 30);
			title.setFont(new Font("华文楷体", Font.BOLD, 18));
			title.setForeground(Color.pink);
			p1.add(title);

			
			lbshoppingid = new JLabel("货   号：", JLabel.LEFT);
			lbshoppingid.setFont(new Font("华文楷体", Font.BOLD, 14));
			lbshoppingid.setForeground(Color.pink);
			...
			lbshopname.setFont(new Font("华文楷体", Font.BOLD, 14));
			lbshopname.setForeground(Color.pink);
			...
			lbprice.setFont(new Font("华文楷体", Font.BOLD, 14));
			lbprice.setForeground(Color.pink);
			...
			lbnum.setFont(new Font("华文楷体", Font.BOLD, 14));
			lbnum.setForeground(Color.pink);
			...
			lbsumnum.setFont(new Font("华文楷体", Font.BOLD, 14));
			lbsumnum.setForeground(Color.pink);
			...
			add = new JButton("新增");
			add.setFont(new Font("华文楷体", Font.BOLD, 14));
			add.setForeground(Color.pink);
			add.setBounds(30, 260, 80, 30);
			quxiao = new JButton("取消");
			quxiao.setFont(new Font("华文楷体", Font.BOLD, 14));
			quxiao.setForeground(Color.pink);
			...
			title = new JLabel("更改货物", JLabel.CENTER);
			title.setBounds(70, 15, 100, 30);
			title.setFont(new Font("华文楷体", Font.BOLD, 18));
			title.setForeground(Color.pink);
			p1.add(title);
