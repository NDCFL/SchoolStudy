...
public class login extends JFrame implements ActionListener{
	...
	public login() {
		...
		title = new JLabel("闹钟系统登录");
		title.setBounds(100, 20, 100, 30);
		panel.add(title);
		
		username = new JLabel("昵称：");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==login){
			...
			if(user.getText().equals("")){
				JOptionPane.showMessageDialog(null, "昵称不能为空","注册信息",JOptionPane.ERROR_MESSAGE);
				return;
			...
			dispose();
			JOptionPane.showMessageDialog(null, "恭喜你注册成功！开始使用吧","闹钟系统",JOptionPane.INFORMATION_MESSAGE);
			new Time();
		}
