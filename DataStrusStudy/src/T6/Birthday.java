...
public class Birthday extends JFrame implements ActionListener{
	...
	public Birthday() {
		...
		js.setBounds(0,80,580, 292);
		
		panel.add(js);
		
		lbheadtitle = new JLabel("好友信息管理");
		lbheadtitle.setBounds(220, 30, 200, 30);
		lbheadtitle.setFont(new Font("楷体",Font.BOLD,24));
		lbheadtitle.setForeground(Color.black);
		panel.add(lbheadtitle);
		
		lbtitle = new JLabel("好友新增");
		lbtitle.setBounds(660, 50, 80, 30);
		lbtitle.setForeground(Color.black);
		panel.add(lbtitle);
		
		lbname = new JLabel("姓名：");
		lbname.setBounds(610, 90, 50, 30);
		lbname.setForeground(Color.black);
		panel.add(lbname);
		
		name = new JTextField();
		name.setBounds(660, 90, 120, 30);
		panel.add(name);
		
		
		lbsex = new JLabel("性别：");
		lbsex.setBounds(610, 130, 50, 30);
		lbsex.setForeground(Color.black);
		panel.add(lbsex);
		
		man = new JRadioButton("男",true);
		man.setBounds(660, 130, 50, 30);
		man.setForeground(Color.black);
		panel.add(man);
		
		weman = new JRadioButton("女",false);
		weman.setBounds(710, 130, 40, 30);
		weman.setForeground(Color.black);
		panel.add(weman);
		...
		lbbirthday.setBounds(610, 170, 50, 30);
		lbbirthday.setForeground(Color.black);
		panel.add(lbbirthday);
		
		birthday = new JTextField();
		birthday.setBounds(660, 170, 120, 30);
		panel.add(birthday);
		
		lbhobit = new JLabel("爱好：");
		lbhobit.setBounds(610, 220, 60, 30);
		lbhobit.setForeground(Color.black);
		panel.add(lbhobit);
		
		hobit = new JTextField();
		hobit.setBounds(660, 220, 120, 30);
		panel.add(hobit);
		
		lbphone = new JLabel("Tel：");
		lbphone.setBounds(610, 270, 60, 30);
		lbphone.setForeground(Color.black);
		panel.add(lbphone);
		
		phone = new JTextField();
		phone.setBounds(660, 270, 120, 30);
		panel.add(phone);
		
		lbxinge = new JLabel("性格：");
		lbxinge.setBounds(610, 320, 60, 30);
		lbxinge.setForeground(Color.black);
		panel.add(lbxinge);
		
		xinge = new JTextField();
		xinge.setBounds(660, 320, 120, 30);
		panel.add(xinge);
		...
		closemusic.setForeground(Color.black);
