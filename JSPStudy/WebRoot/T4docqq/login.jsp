...
<html>
  ...
  <body>
    ...
    <form action="T4docqq/login.jsp" name="form1" method="post">
	    <table width="240" height="100" align="center" border="0">
	    	...
	    	<tr><td colspan="2" align="center"><input type="submit" name="sub1" id="sub1" value=" 登 录 " onclick="yanzheng();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" name="re1" id="re1" value="清空"></td></tr>
	    </table>
	</form>
