...
<html>
  ...
  <h1 align='center'><font color="blue">教师信息的更改</font></h1>
  	...
  	<input type="hidden" name="teacherid" value="<%=request.getParameter("teacherid") %>">
  		<tr>
	  		<th>教师名称</th>
	  		<td><input type="text" name="teachername" style="width:150px" value="<%=new String(request.getParameter("teachername").getBytes("iso-8859-1"),"utf-8") %>"></td>
	  		<td><font color="red" size="5">*必填内容</font></td>
  		</tr>
  		<tr>
  			<th>教师比重</th>
	  		<td><input type="text" name="teachergread" style="width:150px" value="<%=request.getParameter("teachergreade") %>"></td>
	  		<td><font color="red" size="5">*必填内容</font></td>
  		</tr>
