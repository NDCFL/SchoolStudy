...
<html>
  ...
  <table align="center">
	...
	%>
		<td align="center">
		<a href="T7doc/teacherupdate.jsp?teacherid=<%=teacherbean.getTeacherid() %>&order=update&teachername=<%=teacherbean.getTeachername() %>&teachergreade=<%=teacherbean.getTeachergread() %>"> 修 改 </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
