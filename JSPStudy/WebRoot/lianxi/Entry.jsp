...
<html>
  ...
  <h1 align="center">报名系统</h1>
  <hr color="blue" size="5"/>
  <form action="lianxi/studentid.jsp" method="post" name="form1" onsubmit="return yanzheng();">
  <font face="华文行楷" color='blue'>
  <center>
  	<table border="0" width="400" height="400" align="center">
	  	
	  		<tr><td align="center" id="time"><h1>报名系统</h1></td></tr>
	  		<tr><td >学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;好：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="name" size="19"></td></tr>
	  		<tr><td>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="pass1" size="20"></td></tr>
	  		<tr><td>受教育程度：<input type="text" name="pass2" ></td></tr>
	  		...
	  		<tr><td>成&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;绩：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gread" value="及格" checked>及格<input type="radio" name="gread" value="不及格">不及格</td></tr>
	  		<tr><td>
	  				课&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;程：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
