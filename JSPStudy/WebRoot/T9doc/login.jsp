...
<html>
  ...
  <body>
    ...
    <form action="T9doc/checklogin.jsp" name="form1" method="post" onsubmit="return yanzheng();">
	    <table width="240" height="100" align="center" border="0">
	    	...
	    	<tr><td colspan="2" align="center"><input type="submit" name="sub1" id="sub1" value="提交" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" name="re1" id="re1" value="清空"></td></tr>
	    </table>
	</form>
  </body>
</html>
