   ...
   <hr color="bule" size="5px">
	...
	<%
			...
			Statement st = con.createStatement();
   			...
   			out.println("<html><head><title>图书价格览表</title></head><body><table align='center'><tr><td><a href='T7doc/privaceadd.jsp'> 新 增</a></td></tr></table><table border='1' align='center' width='500' height='400'><tr><td colspan='6' align='center'>图书价格览表</td></tr>");
