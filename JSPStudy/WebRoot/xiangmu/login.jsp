...
<body>
    ...
    <div id="js-show-modal" class="launch-button">显示窗口
    ...
    <div id="js-modal-holder" class="modal-holder">
      ...
      <form action="MyJsp.jsp" id="js-modal" class="modal" method="post">
        ...
        <div class="modal__section">
            <div class="input-with-label">
              ...
              <label for="name" class="input-with-label__label">昵 称
        ...
        <div class="modal__section grid grid--sliced grid--gutter-x2">
          <div class="grid-bit grid-bit--14-20">
            <button type="submit" name="sub">登   录</button>
          </div>
          <div class="grid-bit grid-bit--6-20">
            <button class="button--grey" onclick="window.close()">关   闭</button>
          </div>
        </div>
      </form>
