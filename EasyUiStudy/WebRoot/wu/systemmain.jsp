...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath %>wu/css/admin.css">
    <script src="<%=basePath %>wu/js/jquery.js"></script>   
</head>
<body style="background-color:#f2f9fd;">
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/11.jpg" class="radius-circle rotate-hover" height="50" alt="" /></h1>
  </div>
...
<div class="leftnav">
  ...
  <h2><span class="icon-user"></span>物流管理</h2>
  <ul style="display:block">
    <li><a href="<%=basePath %>wuliuservlet?order=list" target="right"><span class="icon-caret-right"></span>新增物流</a></li>
  </ul>   
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="<%=basePath %>wuliuservlet?order=list" name="right" width="100%" height="100%"></iframe>
</div>
