...
<div class="GenTopHeader" style="margin-top: 0px;">
    <ul class="Page"  id="GenTopBar"><li class="fl f14" id="Til"><a >中国最大的IT技能学习平台</a></li>
		 	...
		 	<tr><td align="left">
		 		<c:if test="${f.fourmtype==0}">
			 		<div style="float:left">
			 			<p><img src="${f.userface}" width="30px" height="30px"/>${f.username}</p>
			 			<p>&nbsp;&nbsp;&nbsp;&nbsp;提问：${f.countent}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${f.forumdate}</p>
			 		</div>
		 		</c:if>
		 	</td></tr>
		 	<tr>
		 		<td align="right">
		 			<c:if test="${f.fourmtype==1}">
				 		<div style="float:right">
				 			<p><img src="${f.teacherface}" width="30px" height="30px"/>${f.teachername}</p>
				 			<p>&nbsp;&nbsp;&nbsp;&nbsp;回复：${f.countent}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${f.forumdate}</p>
				 		</div>
				 	</c:if>
		 		</td>
		 	</tr>
...
<div class="Footer">
    <div class="Page">
        <table class="QRcode tc">
            <caption>
                <a href="<%=basePath %>courselistservlet?order=app" title="IT课堂"><img src="<%=basePath %>image/itlogo.png" alt="51cto学院" width="194" height="40"/>
            </caption>
            <tr>
                <td>
