...
<form name="form1" id="flowForm" method="post" action="<%=basePath %>courselistservlet?order=fukuan&courseid=<%=request.getAttribute("courseid") %>">
  <table class="GoodList">
    <tbody>
      ...
      <tr>
        ...
        <td class="red priceNew Last">￥<strong>${(requestScope.courseprice)*(requestScope.price)/10}</strong></td>
      </tr>
            <tr>
        <td class="Billing tr" colspan="3">
          <div class="tr">
            <p>共 <strong class="red">1</strong> 件商品,合计<span class="red f20">￥<strong>${(requestScope.courseprice)*(requestScope.price)/10}</strong></span></p>
          </div>
        </td>
      </tr>
    </tbody>
  ...
  <div class="Finish">
    ...
    <input name="youhui" value="${coursebean.price*(10-requestScope.price)/10}" type="hidden"/>
