    ...
    <table class="table table-hover text-center">
      ...
      <tr width="100%">
		...
		<td class="pagelist" colspan="3" align="center">
			...
			<a href="<%=basePath %>courselistservlet?order=liuyanlist&currenpage=1&handle=firstpage">首   页</a>
			<a href="<%=basePath %>courselistservlet?order=liuyanlist&currenpage=${pager.currentpage }&handle=uppage">上一页</a> <span class="current">1</span>
			<a href="<%=basePath %>courselistservlet?order=liuyanlist&currenpage=${pager.currentpage }&handle=downpage" >下一页</a>
			<a href="<%=basePath %>courselistservlet?order=liuyanlist&currenpage=${pager.sumpage }&handle=lastpage">尾  页</a> 
		</td>
      </tr>
    </table>
