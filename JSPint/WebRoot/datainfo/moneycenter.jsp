...
<div class="userbox">
<div class="usInfo">
<img height="100" width="100" src="http://ucenter.51cto.com/avatar.php?uid=12569085&size=middle" class="avatar" />
<div class="figure">
<h3>你好，${studentbean.studentname}</h3>
<div class="us-mb clearfix">
<a class="n-bdMbl" href="/index.php?do=account&m=phone">未绑定手机</a>
</div>
