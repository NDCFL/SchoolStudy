...
%>
    ...
    <meta name="csrf-token" content="V1NBaGRyMUkPYnkBVhAABgMXNlouXwIeGTEoABwXXw0jYhkBJxRLOA==">
		<title>51CTO技术家园</title>
		<link rel="shortcut icon" href="https://static3.51cto.com/home/web/images/favicon.ico" type="image/x-icon">	
 ...
 <div class="sign">
  <div class="loginWrap"> <a class="logo"></a>
    <div class="loginPic zxflogoPic clearfix">
      <div class="loginImg">
         <a href="http://x.51cto.com/act/cto/camp/page/course_list?dl" target="_blank"><img src="https://s1.51cto.com/wyfs02/M02/8D/94/wKiom1iifguifAP9AAHpfdkY4jY536.jpg" alt="" border="0" /></a>   
      </div>
      <div class="loginBord" id="login-base">
        <div class="loginTit">

          <div class="tosignup"> <a target="_blank" href="http://51ctohome.blog.51cto.com/1805422/579769" style="margin-right:10px;color:#969696;">无法登录?</a>|<a href="/user/register?reback=http%3A%2F%2Fgaozhao.51cto.com%2Fresume%2Fadd%3FinviteId%3DMTA1ODgxNjc%3D" style="margin-left:10px;color:#d54e4e;">注册</a> </div>

          <h1 style="color:#333;">登录51CTO</h1>
        </div>
           <form id="login-form" action="/index?reback=http%3A%2F%2Fgaozhao.51cto.com%2Fresume%2Fadd%3FinviteId%3DMTA1ODgxNjc%3D" method="post" role="form">
<input type="hidden" name="_csrf" value="V1NBaGRyMUkPYnkBVhAABgMXNlouXwIeGTEoABwXXw0jYhkBJxRLOA==">		
...
<div class="custom invalid error_9o8Kl" style="display:none"></div>
          ...
          <div class="clearfix zxfDl">
            <a class="fr" href="/forgot-password/find-password?reback=http%3A%2F%2Fgaozhao.51cto.com%2Fresume%2Fadd%3FinviteId%3DMTA1ODgxNjc%3D">忘记密码?</a>
...
<br>Copyright &copy; 2005-2017 <a href="Http://www.51cto.com">51CTO.COM</a> 版权所有
	...
	<script src="https://static3.51cto.com/home/web/js/loginForm.js?v=10007"></script>
