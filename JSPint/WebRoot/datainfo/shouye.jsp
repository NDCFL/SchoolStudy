...
<div class="GenTopHeader" style="margin-top: 0px;">
    <ul class="Page"  id="GenTopBar"><li class="fl f14" id="Til">中 国 最 大 的 IT 技 能 学 习 平 台</li>
       ...
       <c:if test="${studentBean!=null}">
       		 ...
       		 <li class="fr reg"><a href="<%=basePath %>loginservlet?order=loginin&name=<%=studentBean.getStudentmobile() %>" target="_blank"><%=studentBean.getStudentname() %></a></li>
       </c:if>
    </ul>
</div><!-- 顶部广告位 -->
<div class="Page Top">
  ...
  <dd>
        ...
        <div class="Login">
            <div class="UserInfo">
                <c:if test="${studentBean!=null}">
                	<div class="Avatar">
                    	<a href="<%=basePath %>loginservlet?order=loginin&name=<%=studentBean.getStudentmobile() %>"><img src="<%=basePath%><%=studentBean.getStudentface() %>" id="UserAvatar" style="width:70px;height:80px"></a>
                    	<img src="https://static1.51cto.com/edu/index/images/avatar.png" >
               	 	</div>
                </c:if>
                <c:if test="${studentBean==null}">
                	<div class="Avatar">
                    	<img src="<%=basePath %>image/face.gif" id="UserAvatar" style="width:70px;height:60px">
                    	<img src="https://static1.51cto.com/edu/index/images/avatar.png" >
               	 	</div>
                </c:if>
                <div class="Main">
                    <c:if test="${studentBean!=null}">
                    	<h3 id="UserName" class="oneLine">当前用户&nbsp;&nbsp;&nbsp;<a href="<%=basePath %>loginservlet?order=loginin&name=<%=studentBean.getStudentmobile() %>"><%=studentBean.getStudentname() %></a></h3>
                    </c:if>
                    <c:if test="${studentBean==null}">
                		<div class="Btns" id="BannerBtn">
                    		<p id="UserScore"><a href="<%=basePath %>datainfo/zhuce.jsp" target="_blank">注册</a> 领取520元新人大礼包~</p>
                		</div>
                	</c:if>
                	 <c:if test="${studentBean!=null}">
                		<div class="Btns" id="BannerBtn">
            ...
            <ul class="NewsList">
                <c:forEach items="${courselist}" var="s">
                	<c:if test="${s.ismoney==0}">
                		<li><a href="<%=basePath %>courselistservlet?order=datainfo&sectionid=${s.sectionid}&courseid=${s.course_id}" target="_blank" class="red" title="【免费】2017Linux高端课程">【免费】${s.course_name}&nbsp;&nbsp;&nbsp;&nbsp;${s.one_word}</a></li>
                	</c:if>
                	<c:if test="${s.ismoney==1}">
                		<li><a href="<%=basePath %>courselistservlet?order=datainfo&sectionid=${s.sectionid}&courseid=${s.course_id}" target="_blank" class="red" title="【收费】2017Linux高端课程">【付费】${s.course_name}&nbsp;&nbsp;&nbsp;&nbsp;${s.one_word}</a></li>
                	</c:if>
                </c:forEach>
            </ul>
        </div>
        ...
        <ul class="List ListPXB">
        	<c:forEach items="${courselist}" var="s">
        		<li>
	                ...
	                <p class="c9"><a href="<%=basePath %>courselistservlet?order=datainfo&courseid=${s.course_id}" target="_blank" title="${s.one_word}">随到随学&nbsp;20周共 348 节课</a></p>
            	</li>
        	</c:forEach>
        </ul>
        <!-- 职业路线图 -->
    ...
    <div class="Page">
        ...
        <div class="Logo fl">
            ...
            <table>
                <tr>
                    <td>
                        <img src="https://static1.51cto.com/edu/index/images/qrcode.png">
                        <p>学院APP</p>
                    </td>
                    <td>
                        <img src="https://static1.51cto.com/edu/index/images/qrcode2.png">
                        <p>官方微信</p>
                    </td>
                </tr>
            </table>
