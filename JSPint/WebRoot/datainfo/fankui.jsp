...
<div class="pagebg" style="width: 100%;background: #fff;">
    <div class="Page" style="height:90px;">
        <a href="http://edu.51cto.com/px/train/115?banner" target="_blank">
            <img src="https://s1.51cto.com/images/201702/4988085302c43cf1dec526f92c04f3faa8ac9f.jpg" />
        </a>
    </div>
</div>
<div class="Header">
...
<script type="text/javascript" src="https://static1.51cto.com/edu/js/plupload/plupload.full.js"></script>
...
<div class="w960 bgfff">
	...
	<tr>
		<td width="210" valign="top" class="help_menu">
			<ul>
				<li class="a01"><a href="/help.html">用户帮助</a></li>
				<li class="a05 cur"><a href="/user/feedback.html">用户反馈</a></li>
								<li class="a03"><a href="/partner/help.html">机构帮助</a></li>
							</ul>
        <h2>学员交流群</h2>
        <div class="Group">
                    <div class="Item">
            ...
            <a href="http://shang.qq.com/wpa/qunwpa?idkey=4c59af317566cdb94f8bfe93d60044c3475a02342da1d2bdb9200ebba062da75" target="_blank"></a>
          </div>
                    <div class="Item">
            <div class="Main">
              <h5>大数据交流群</h5>
            ...
            <a href="http://shang.qq.com/wpa/qunwpa?idkey=341d885511b8be954c54bcf3eba59e53f3454249995543e551b6a9c5dcfeb8e3" target="_blank"></a>
          </div>
                    <div class="Item">
            <div class="Main">
              <h5>微信H5交流群</h5>
              <p class="red">xljx_888888</p>
            </div>
            <a href="http://shang.qq.com/wpa/qunwpa?idkey=efaa5f649dac874fdf31d5ab2f281c7ab4d87de57d529253604591f819bc654d" target="_blank"></a>
          </div>
                  </div>
        <a href="http://51edu.blog.51cto.com/8899635/1862738" target="_blank" class="btn">更多QQ交流群&gt;&gt;</a>
		</td>
		<td align="left" valign="top">
			<form id="feedBackForm" method="post" action="/index.php?do=user&m=feedback&rhref=aHR0cDovL2VkdS41MWN0by5jb20vY291cnNlL2NvdXJzZV9pZC02NjU1Lmh0bWw%3D">
			<div>
				<div class="fbLi">
					...
					<tr>
						...
						<td valign="middle">
							...
							<p class="font14 c90">
								您遇到的问题也许在这里已经有解答了，<a href="/help.html" target="_blank" class="c_green">找找看 ></a>
							</p>
							<p>您可以加入IT课堂产品体验群 275300091，随时反馈~</p>
						</td>
					</tr>
					</table>
				</div>
				<div class="fbLi">
					...
					<tr>
						...
						<td align="left" valign="middle">
							...
							<p class="font12">
								<input name="proType" type="radio" checked="checked" value="1"/>
								<label>视频播放</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<input type="hidden" name="feedback_code" value="35b8d8d3f6ddf85" />
						</td>
					</tr>
					</table>
				</div>
				<div class="fbLi" id="proTypeDiv_0" style="display:none;">
					...
					<tr>
						...
						<td valign="top">
							<p class="font1 lh30">请详细描述您的建议、意见、问题等：</p>
							<p class="font14">
								<label for="textarea"></label>
								<textarea name="describe_0" id="describe_0" cols="32" rows="5" class="area410 c_ae"></textarea>
							</p>
						</td>
					</tr>
					<tr><td></td><td><span class="c_red" id="describe_0_tip"></span></td></tr>
					</table>
				</div>
						...
						<td valign="top">
							...
							<tr>
								<td width="3%" align="left">
									<img src="https://static1.51cto.com/edu/images/arr-ico.png" width="11" height="9"/>
								</td>
							...
							<tr>
								...
								<td class="c90">
									1. 请检查flash插件是否安装（如果没安装则看不到播放器）<br/>
									2. Flash插件下载地址：
							...
							<tr>
								...
								<td class="c90">
									1. 刷新几次后可播放正常，并且无卡顿，此为正常现象，有可能是网络波动引起的；<br/>
									2. 怎么刷新都无法播放。
								</td>
							</tr>
							<tr>
							...
							<tbdoy>
								...
								<tr>
									<td width="14%" height="115" valign="top">
										<label><span class="c_red">*</span> 问题简要描述</label>
									</td>
									<td width="86%" valign="top">
										<textarea name="describe_1" id="describe_1" cols="32" rows="5" class="area410 c_c8">描述中必须包括播放视频问题出现时间，使用的浏览器、浏览器版本。</textarea>
									</td>
								</tr>
								<tr><td></td><td><span class="c_red" id="describe_1_tip"></span></td></tr>
								<tr>
									<td height="40" valign="middle">
										<label><span class="c_red">*</span> 问题视频地址
										</label>
									</td>
									<td height="40" valign="middle">
										<input name="videoUrl" type="text" class="inp148 c_ae" id="videoUrl" value="" style="width:410px;"/>
									</td>
								</tr>
								<tr><td colspan="2"><span class="c_red" id="videoUrl_tip"></span></td></tr>
								<tr>
							...
							<tbody id="isHide">
								<tr>
									<td height="50" colspan="2" valign="middle">
										<div id="videoImg_c"><span class="c_red">*</span> 问题视频截图
										<span href="javascript:void(0);"><img id="videoImg_p" src="https://static1.51cto.com/edu/images/up-btn.png"align="absmiddle" /></span>
										<input type="hidden" class="imgUpload" name="videoImg" id="videoImg" value="" />
								...
								<tr>
									<td height="50" colspan="2">
										<div id="pingImg_c"><span class="c_red">*</span> ping <span class="videoorv1">v1</span>.51cto.com截图
										<span href="javascript:void(0);"><img id="pingImg_p" src="https://static1.51cto.com/edu/images/up-btn.png"align="absmiddle" /></span>
										<input type="hidden" class="imgUpload" name="pingImg" id="pingImg" value="" />
								...
								<tr>
									<td height="35" colspan="2" valign="top" class="c90">
										方法：电脑屏幕左下角开始-&gt;运行-&gt;输入cmd-&gt;输入ping <span class="videoorv1">v1</span>.51cto.com-&gt;截图  <a href="https://s1.51cto.com/wyfs02/M00/44/37/wKiom1PgNnTylWnCAAkRl0LxSCA379.jpg" target="_blank" class="c_green">例如&gt;&gt;</a>
									</td>
								</tr>
								<tr>
									<td colspan="2" valign="bottom">
										<div id="tracertImg_c"><span class="c_red">*</span> tracert <span class="videoorv1">v1</span>.51cto.com截图
										<span href="javascript:void(0);"><img id="tracertImg_p" src="https://static1.51cto.com/edu/images/up-btn.png"align="absmiddle" /></span>
										<input type="hidden" class="imgUpload" name="tracertImg" id="tracertImg" value="" />
										<span class="c_red" id="tracertImg_tip"></span></div>
									</td>
								</tr>
								<tr>
									<td height="35" colspan="2" valign="top" class="c90">
										方法：电脑屏幕左下角开始-&gt;运行-&gt;输入cmd-&gt;输入tracert <span class="videoorv1">v1</span>.51cto.com-&gt;截图  <a href="https://s1.51cto.com/wyfs02/M00/44/37/wKiom1PgNnTylWnCAAkRl0LxSCA379.jpg" target="_blank" class="c_green">例如&gt;&gt;</a>
									</td>
								</tr>				
								<tr>
									<td height="40" colspan="2" valign="bottom">
										<div id="IpImg_c"><span class="c_red">*</span> IP截图
										<span href="javascript:void(0);"><img id="IpImg_p" src="https://static1.51cto.com/edu/images/up-btn.png" align="absmiddle" /></span>
										<input type="hidden" class="imgUpload" name="IpImg" id="IpImg" value="" />
								...
								<tr>
									<td height="30" colspan="2" valign="top">
										<span class="c90"> 请大家不要提供内网IP，可在百度上输入IP,将截图给我们。<a href="https://s1.51cto.com/wyfs02/M00/44/37/wKiom1PgNnTylWnCAAkRl0LxSCA379.jpg"  target="_balnk" class="c_green">例如&gt;&gt;</a></span>
									</td>
								</tr>
								<tr>
									<td height="50" colspan="2">
										<label><span class="c_red">*</span> 运营商</label>
										<input name="operators" type="text" class="inp148 c_c8" id="operators" value="电信、联通等等"/>
						...
						<td valign="top">
							...
							<tr>
								...
								<td>
									...
									<input type="text" name="email" id="email" class="inp148" value=""/>
				...
				<a class="btn_red" style="width:75px; display:block; margin:15px auto;" onclick="submitFeedbackForm()">提交</a>
			</div>
			</form>
		</td>
	</tr>
