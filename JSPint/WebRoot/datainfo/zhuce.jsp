...
%>
    ...
    <meta name="csrf-token" content="MTJEWkYuNzEcSD4XIHZQX2tiIjwBS2JEd3wTOXJWQ0RWV2lrdh0aYg==">
...
<div class="nav">
    <div class="nav_nr">
        <dl class="nav1">
            <dt><a href="<%=basePath %>courselistservlet?order=list" target="_blank"><img src='<%=basePath %>image/itlogo.png' alt="" style="width:130px"></a></dt>
            <dd>账号通行证</dd>
        </dl>
        <dl class="nav2">
...
<!--头部文件结束-->    
<form action="<%=basePath %>studentservlet?order=add" method="post" name="form1">
<div class="zczh">
	<h2>注册账号</h2>
<div class="form-group">
    <div style="position: relative">
        <input class="string required form-control" id="registerName" name="registerName" onblur ="checkReisterType(this.name);"  placeholder="请输入有效账号"required="required" type="text" autocomplete="off">
        <div class="sjhzc">请输入有效账号
            <span><img src='https://static4.51cto.com/home/web/images/reg_2015//bbline.png'></span>
        </div>
        <span class="loading"><img src='https://static4.51cto.com/home/web/images/reg_2015/ajax-loader-big.gif' height="16" width="16"></span>
    ...
    <div class="regr">
        ...
        <input  onblur="checkVerify(this.name);" onkeyup="checkVerify(this.name);" class="verify-code string user_verify" id="codev" maxlength="4" name="codev" placeholder="验证码" type="text" value="" />
        <a class="boxyzm_yy " id ="captchaImage"><img id="codes" src="${pageContext.request.contextPath }/enimg.jsp" alt="图片无法加载" title="点击换图"  onclick="refresh();" style="cursor:pointer" ></img></a>
        </div>
        <span class="red_ts codev"></span>
        <span class="red_ts verify_code"></span>
        <input   name="checkUser" id="username"  onkeyup = "checkIsUser(this.name);" value=""  placeholder="用户名"  type="text" autocomplete="off"/>
        <div class="sjhzc">请输入有效账号
            <span><img src='https://static4.51cto.com/home/web/images/reg_2015/bbline.png'></span>
        </div>
        <span class="red_ts checkUser" id="checkUser" style="display:block"><div style="color:#1b66c7">用户名一旦设置成功，不能修改</div></span>
        <input  id="userpwd" onkeyup="pwStrength(this.value)" value="" onBlur="pwStrength(this.value)" onChange="pwStrength(this.value)" size="15" name="password" placeholder="密码"  type="password" autocomplete="off" />
    ...
    <p class="ydxy"><input type="checkbox" checked name="checkbox" onclick ="check_provision()" value=""><span>我已经认真阅读并同意<a target="_blank" href="<%=basePath %>datainfo/login.jsp">《IT课堂服务条款》</a></span></p>
    <span  class="red_ts provision"></span>
    <div class="form-group1">
        <input class="btn input-submit" data-confirm-text="登录" data-loading-text="提交中.." data-login-text="登录" data-loginandsetpassword-text="设置密码并登录" data-register-text="注册"  id="submit"  type="submit" value="立即注册">
...
<div class="fixexit_small">
    <div class="infixexit">
        ...
        <div class="exit_list exit_list_zxun"><a  class="ina" target="_blank"></a></div>
    </div>
</div>
...
<input type="hidden" id="reback" value="http://edu.51cto.com/center/user/index/login-success?sign=de2f8R-DxxMVUB0AyDQFs4BBMlhxDWpF6n9NpLxEauDlNOJNglwUK2y21t1AagAL2WFihCID7R2-OVIIObiDi9PNqbcV6VdqHgBBhjdnVA6GyBM8YKu6jWpvUaFjMidtVKn0">    <script src="https://logs.51cto.com/rizhi/count/count.js"></script>
...
<script type="text/javascript">
    ...
    <script src="https://static4.51cto.com/home/web/js/reg_2015/footer.js?v=10002"></script>
