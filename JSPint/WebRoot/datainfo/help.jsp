...
<meta name="description" content="51CTO学院是专业的IT在线教育平台，聘请云计算、大数据、HTML5、网络安全、服务器、Android、iOS、开发技术、SQL Server、Oracle、数据库等技术领域的专家，更有思科认证、软考、Linux认证、微软认证、H3C认证系列精品IT在线视频培训课程，汇集最顶尖的IT技术课程，最优秀的IT培训讲师授课视频，大量技术培训视频教程，学员付费后可在线观看，此外还可以获得专家讲师亲自答疑，并参加课程的在线评测。" />
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="210" valign="top" class="help_menu">
        <ul>
          <li class="a01 cur"><a href="<%=basePath %>courselistservlet?order=help">用户帮助</a></li>
          <li class="a05"><a href="<%=basePath %>courselistservlet?order=fankui">用户反馈</a></li>
                    <li class="a03"><a href="<%=basePath %>courselistservlet?order=help">机构帮助</a></li>
                  </ul>
        <h2>学员交流群</h2>
        <div class="Group">
                    <div class="Item">
...
2、在课程页直接点击“立即购买”按钮，进入购买流程；也可以点击“加入购物车”，在购物车里点击“去结算”，进入购买流程（购物车功能尤其适合购买多个课程，实现多个课程一次性购买；在网站上加入购物车后，也可以在学院手机APP中“购物车”进入购买流程）；<br/>
/3、确认所购买的课程情况，进入51CTO支付中心，可使用人民币现金支付，如果账户里有金币，可以配合使用“余额支付”（1金币可抵1元），如下：
<img src="http://s2.51cto.com/wyfs02/M01/88/24/wKiom1fqRybBRoWjAACf0rRWkOc613.jpg" /><br/>
</div></dd> 
 <dt><font color="red">视频课程能否下载？手机上购买课程电脑上能否观看？是否支持多人观看？</font></dt>
  <dd><div>
视频课程可以下载下来，在无网络环境下离线学习，目前支持下载到手机、平板电脑，不支持下载到pc电脑。手机上购买视频课程，可以在电脑和其他移动APP上观看学习。所有视频课程不支持多人观看。
</div></dd> 
<dt>如何付款？（支付宝/微信支付/网银/信用卡/美元外币均支持）</dt>
  <dd><div>
1.支付宝：淘宝旗下支付渠道，适用于有支付宝账号的同学，手机扫码即可完成支付，安全便捷，官方推荐；<br/>
2.微信支付：微信旗下支付渠道，适用于有微信支付账号的同学，手机扫码即可完成支付，安全便捷，官方推荐；<br/>
3.中国银联：中国官方的银行卡联合组织，适用于没有支付宝、微信支付但有国内银行储蓄卡和信用卡的同学，不特别推荐<br/>
4.Paypal：美国eBay旗下知名支付工具，中文名“贝宝支付”，适用于没有支付宝、微信支付的国外同学Paypal账号及外币信用卡支付；<br/>
5.支付如遇到问题，可拨打电话4008519651，或者点击网站右侧“点我咨询”图标使用QQ咨询客服人员如何操作。<br/>
</div></dd> 
<dt><font color="red">优惠券有何使用规则？能否和折扣/学分/学习码（卡）同时使用？</font></dt>
  <dd><div>
1.优惠券不能和折扣/学分/学习码等同时使用；<br/>
2.优惠券不能用于套餐和培训班的购买中；<br/>
3.无门槛优惠券用于购买定价大于等于优惠券额度的课程，有门槛的优惠券只能用于购买定价在优惠券额度3倍以上的课程中；<br/>
4.优惠券一经使用，不再返还；<br/>
5.优惠券不能进行兑、出售或转让等操作，一经发现，作废处理。<br/>
 </div></dd>
<dt>如何使用优惠券？</dt>
  <dd><div>进入“我的学院”->“我的优惠券”，可查看优惠券情况，包括未使用优惠券、已使用优惠券、已过期优惠券。使用优惠券的操作流程：<br/>
<font color="red">一、购买单个课程使用优惠券：</font><br/>
第一步：在课程页，点击"立即购买课程"；
<img src="http://s2.51cto.com/wyfs02/M02/58/7C/wKiom1Sya3Pj2U95AADo3hdCp5w640.jpg" /><br/><br/>
第二步："确认课程清单"页面，点击“使用优惠”<br/>

<img src="http://s2.51cto.com/wyfs02/M00/58/79/wKioL1SybEbxBzEnAABsH-bzYZo750.jpg" /><br/><br/>

第三步：“选择优惠方式”弹窗里，选择“使用优惠券”<br/>
<img src="http://s2.51cto.com/wyfs02/M01/58/79/wKioL1SybICjiA7cAAENxczpMzg418.jpg" /><br/><br/>

第四步：使用优惠券后，即抵消相应金额，实现优惠<br/>
<img src="http://s2.51cto.com/wyfs02/M00/58/79/wKioL1SybNeSZ9DuAACBdiQ49kE787.jpg" /><br/><br/>

备注：如果要取消优惠，请参照第二步，点击“修改优惠”-弹窗中点选“取消优惠”-确定-实现对该优惠券的取消使用。<br/><br/>

<b><font color="red">二、购买多个课程（在购物车中）使用优惠券：</font></b><br/><br/>

第一步：页面右上角点击“我的购物车”<br/>
<img src="http://s2.51cto.com/wyfs02/M02/58/7C/wKiom1SybG2im_DeAAA0GuYHIi4088.jpg" /><br/><br/>

第二步：进入“我的购物车”页面，点击右下角“结算”<br/>
<img src="http://s2.51cto.com/wyfs02/M02/58/7C/wKiom1SybG2im_DeAAA0GuYHIi4088.jpg" /><br/><br/>

第三步：进入“订单信息确认”页面，在课程标题右侧点击“使用优惠”<br/>
<img src="http://s2.51cto.com/wyfs02/M01/58/79/wKioL1SybaKCmk3iAAB-d966pG0687.jpg" /><br/><br/>

接下来，使用优惠券的方法，参见前面第一种情况的第三步。<br/>
</div></dd>
  <dt><font color="red">什么是学习码？如何使用学习码？</font></dt>
  <dd><div>
学习码是由一组由数字和字母组成的验证码，在规定的有效期内，用于免费体验学习部分付费课程。可通过参加学院线上活动、线下沙龙等方式获得。<br/>
使用规则：一个学习码仅限一个IT课堂账号、免费体验观看一个收费课程的前50%内容，不可重复使用，学习码仅提供有效期内课程体验功能，不享受课件下载和讲师答疑服务。
  第一步：进入要学习的课程页面，在“加入购物车”下方找到“学习码观看”文字链并点击，弹出学习码提示框：<br/>
  <img src="http://s2.51cto.com/wyfs02/M02/58/23/wKiom1Sp_rDRF-rYAAEuaDETSCs713.jpg" /><br/>
  第二步：如果是系统发放的学习码（已和账号绑定），直接点击“使用”即可；如果手里拥有学习码或者有学习卡，直接输入学习码点击“使用”即可<br/>
  <img src="http://s2.51cto.com/wyfs02/M02/58/1F/wKioL1Sp__ewX6_HAADmMGYfwGk525.jpg" /> <br/>
  第三步，点击使用后，即可观看学习啦！请注意学习码有效期，加紧学习哦~<br/>
  </div></dd> 
  <dt>购买课程能否开发票？如何开发票？</dt>
  <dd><div>在学院充值或购买课程可开具增值税普通发票，发票内容：服务费，满500元包邮发票，500元以下需支付10元快递费，开发票请提供发票抬头及快递信息，在网站右侧“点我咨询”图标找到在线客服或者拨打电话4008519651开具发票。请务必在3个月内联系客服开具发票，3个月之后将不能开具哦~</div></dd> 
<dt>购买课程后能退款吗？</dt>
  <dd><div>由于每个课程都有免费试看，所以原则上购买后是不能退款的，学员可以与讲师协商沟通，如果达成一致可退还金币（金币可用于购买其他课程）。
</div></dd>
<dt>微职位如何退款？</dt>
  <dd><div><img src="http://i1.51cto.com/images/201701/b996f8d08c551886cb408322951424f7cf9a60.png" /> <br/>
1、退款申请表  <a  target=“_blank”>点击下载>></a>  <br/>
2、退款申请表格填写后发送edu@51cto.com。<br/>
3、学院受理流程须3个工作日，银行及其他第三方支付退款周期见下表。<br/>
<img src="http://i1.51cto.com/images/201701/71a013004d5f8e6122525870dbf6cf842390b7.png" /> 
</div></dd>

  <dt><font color="red">什么是学分？学分有什么用？</font></dt>
  <dd><div>学分是51CTO学院的虚拟积分，可以用来折抵部分现金购买付费课程（100学分=1元），也可以参加官方各类学分兑换礼品活动（学分兑换在学院APP-我-学分兑换页面中进行，学院APP下载地址:http://edu.51cto.com/activity/lists/id-10.html）。</div></dd>
  <dt>什么是可用学分？</dt>
  <dd><div>可用学分是指在单个付费课程购买中，可以用来折抵现金的学分，可用学分折抵现金的数量取决于讲师课程的设置，另外可用

学分必须是整百数，所以一般小于自己的学分总数量。</div></dd>
  <dt>如何获得学分？</dt>
  <dd><div>1、购买课程后或学习完某免费课程后，给课程发表真实评价，发表一条四分以上评价奖励20学分；每个课程的前五个评价，每条奖励5分

；课程评价被管理员加精，奖励10学分；<br/>2、登录后每天可在学院网站首页免费领取5学分，连续5天以上可领10学分，30天以上可领15学分

；<br/>3、在课程和课时页面分享链接到微博等社会化媒体，他人访问即获得2学分，每天最多可获取1000学分；<br/>4、每天发表一篇笔

记，总奖励20学分；每天提问一个问题，总奖励10学分；每天回复一个问题，总奖励10学分；<br/>5、为51CTO学院提建议被采纳，管理员

送学分；<br/>6、参与学院活动奖励学分；<br/>7、更多学分获得途径，将后续推出。以上得分，当所做操作被管理员认定非法及

恶意而删除，相应学分奖励将扣除。</div></dd>
  <dt>发表课程评价如何奖励学分？</dt>
  <dd><div>1) 发表好评评价（综合评分在4分以上），每条奖励20学分；<br/>2) 课程前5条评价，每条奖励5学分；<br/>3) 评价被管理

员加精，每条奖励10学分。以上得分，当所做操作被管理员认定非法及恶意而删除，相应学分奖励将扣除。</div></dd>
<dt id="appraise">如何进行课程评价？综合评价如何计算？</dt>
  <dd><div>学员可以对课程在“课程与描述相符”、“老师的讲解表达”、“老师的答疑服务”三个方面进行评分

。<br/>综合评分为“（课程与描述相符评分+老师的讲解表达评分+老师的答疑服务评分）/3”。

</div></dd>
<dt><font color="red">什么是金币？</font></dt>
  <dd><div>金币是51CTO学院虚拟货币，可以使用金币1:1直接抵扣现金购买课程而没有任何限制，1金币相当于1元人民币<br/>
  </div></dd>
  <dt>如何学习课程？</dt>
  <dd><div>通过搜索和浏览可发现你想要的课程，进入课程页面点击课时标题，可进入课时页面在线观看视频。我们提供大量课程在线免
费观看，部分精品原创课程需支付一定现金才能学习。</div></dd> 
<dt>讲师有何权益？</dt>
  <dd><div>
1.精湛加密：业界最靠谱的视频加密技术，100%保护你的知识版权；<br/>
2.人群精准：用户群精准，聚集1000万IT人在线交流的平台；<br/>
3. 技术变现：让技术与知识变现，固化已有技术知识，收益可持续，留更多时间去研究新技术，实现脑力赚钱，不再依靠重复的体力劳动获得回报；<br/>
4.其他机会：企业内训、项目外包，我们提供更多额外收益机会；<br/>
5.出书服务：图书出版一条龙服务，推荐出版社、社区总编写推荐语、课程配合图书推广、读书频道推广、为图书配套学习卡、优惠券等额外增值项；<br/>
6.人脉拓展：加入学院专家圈，和同行大牛技术交流，拓展人脉；<br/>
7.粉丝集聚：聚集学员群，建立个人品牌，提升个人名气；<br/>
8.在线品牌：高规格的讲师荣誉体系，帮你打造在线教育领域个人品牌；<br/>
9.移动学习：完善的产品支持，移动端用户随时随地学习，老师随时随地指导答疑；<br/>
10.免费门票：免费获得51CTO主办的各种技术峰会门票；<br/>
11.免费礼品：优先获得51CTO定制的各种贴心礼品，荣誉证书等；<br/>
12.贴心服务：学院美女管家们专业贴心的一系列服务。
</div></dd>
  <dt><font color="red">成为学院讲师需要什么条件？</font></dt>
  <dd><div>51CTO学院诚邀各技术领域的技术专家，录制实战课程供学员学习，提升职业技能，申请讲师需具备以下任一条件：

<br/>
  1. IT行业内3年及以上从业经验，自身有丰富的技术知识及经验可以分享<br/>
  2. 曾经拥有过讲师、培训经历<br/>
  3. 平时喜欢在互联网等分享技术（写技术博客、逛技术论坛等） </div></dd>
  
  <dt>如何申请成为讲师？</dt>
  <dd><div>我们欢迎广大技术专家来担任讲师，发布优质课程，分享技术的同时也获得收益，申请地址：IT课堂：在线提交资料申请后，我们将联系您沟通更多细节事项。</div></dd>
  <dt><a name="honor" id="honor" style="color:#666;">什么是讲师荣誉体系？</a></dt>
  <dd><div>讲师荣誉体系，是IT课堂从课程质量、答疑效果、学员评价、销售情况等方面衡量讲师价值综合评分的结果。<br/>讲师荣

誉称号由低到高依次为：认证讲师、中级讲师、高级讲师、特级讲师、金牌讲师。<br/>讲师荣誉有助于帮助学员找到质量高的课程以及服
...
<div class="Footer">
    <div class="Page">
        ...
        <div class="Info fl">
            <div class="Map">
                <a href="<%=basePath%>courselistservlet?order=guanyu" title="关于我们" target="_blank">关于我们</a>
                <span></span>
                <a href="<%=basePath%>courselistservlet?order=help" target="_blank"  title="帮助中心">帮助中心</a>
                <span></span>
                <a href="<%=basePath%>courselistservlet?order=fankui" title="意见反馈" target="_blank">意见反馈</a>
                <span></span>
            ...
            <div class="clear"></div>
            <p class="copy">Copyright &copy; 2005-2017 <a  target="_blank">IT.com</a></p>
        </div>
        <div class="clear"></div>
    </div>
</div>
