      ...
      <div class="form-group">
        ...
        <div class="field">
        	<c:if test="${coursebean.effective==0}">
        		<input type="radio" class="radio" name="isactive" value="0" checked="checked"/>有效<input type="radio" class="radio" name="isactive" value="1"/>无效
        	</c:if>
          	<c:if test="${coursebean.effective==1}">
        		<input type="radio" class="radio" name="isactive" value="0"/>有效<input type="radio" class="radio" name="isactive" value="1"  checked="checked"/>无效
        	</c:if>
        </div>
      </div>
       <div class="form-group">
