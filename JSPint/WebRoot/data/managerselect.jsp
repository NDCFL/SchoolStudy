  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="data/manageradd.jsp"> 添加内容</a> </li>
        <li>搜索：</li>
        <li>
			...
			<tr height='40'>
				...
				<td align="center">
					<div class="button-group"> 
						...
						<a  class="button border-main" href="<%=basePath %>data/updatemanagerpwd.jsp?managerid=${y.manager_id}"  > 更改密码 </a>&nbsp;&nbsp;&nbsp;
