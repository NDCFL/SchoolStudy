			...
			<tr height='40'>
				...
				<td align='center'>
		          ...
		          <div class="button-group"> 
		          	<c:if test="${y.leibie ==2 }">
					  <a class="button border-main icon-edit" href="<%=basePath %>studentservlet?order=shenhestudent&studentname=${y.studentname}">进入审核</a>
					</c:if>
					<c:if test="${y.leibie !=2 }">
					  <a class="button border-main icon-edit" href="<%=basePath %>studentservlet?order=shenhestudent&studentname=${y.studentname}">查看详情</a>
					</c:if>
		          </div>
          </td>
        </tr>
