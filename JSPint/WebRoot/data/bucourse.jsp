    ...
    <ul class="Page"  id="GenTopBar"><li class="fl f14" id="Til"><a href="http://edu.51cto.com/">中国最大的IT技能学习平台</a></li>
        <li class="fr navi"><a  target="_blank" style="background-color:none;">网站导航</a>
            <ul class="navigates">
                ...
                <li><a  target="_blank">申请开课</a></li>
                <li><a  target="_blank">CTO训练营</a></li>
                <li><a  target="_blank">WOT峰会</a></li>
                <li><a  target="_blank">百城沙龙</a></li>
            </ul>
        </li>
	...
	<div class="CoursePage" style="position:relative;z-index: 2;">
		<div class="Page">
			<ul class="Crumbs">
				...
				<li><span>&gt;</span></li>
				<li><a href="/course/courseList/id-81.html" target="_blank"><h2>${o.sectionname}</h2></a></li>
				<li><span>&gt;</span></li>
				<li>${o.one_word}</li>
				<!-- 广告位6  -->
			</ul>
			<div class="CourseIntro page-top">
              ...
              <!-- 手机专享 start -->
					...
					<div class="courseInfo_line courseInfo_line_top">
						<span class="fl">
						${requestScope.num}课时 · ${o.timelength}分钟<em class="lop-top02">|</em>						</span>
					...
					<div class="CourseBtn" style="padding-top: 50px">
						...
						<c:if test="${o.ismoney!=0}">
							<a href="<%=basePath %>courselistservlet?order=gouwuche&sectionid=${o.course_id}"><img src="<%=basePath %>image/button1.png"/></a>
						</c:if>
						<c:if test="${o.ismoney==0}">
...
<a href="<%=basePath %>courselistservlet?order=guanyu" target="_blank">关于我们</a>
            ...
            <div class="clear"></div>
            <p class="copy">Copyright &copy; 2017-2027 <a  target="_blank">51CTO.com</a></p>
        </div>
        <div class="clear"></div>
    </div>
</div>
