...
<div class="page-container">
    <div class="text-c">
        ...
        <input type="text" name="" id="article" placeholder=" 资讯名称" style="width:250px" class="input-text">
        <button name="" id="findarticle" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜资讯</button>
    </div>
...
<script type="text/javascript" src="<%=path%>/css/h-ui/js/H-ui.min.js"></script>
